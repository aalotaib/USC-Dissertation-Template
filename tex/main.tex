...
\input{packages}
\input{acronyms}  % adding acronyms, comment this if you don't use it
...
\begin{preface}
  ...
  % Comment the following 4 lines if you don't want the list of abbreviations
  ...
  % Abstract Page
  \acresetall  % reset acronyms, comment this if you're not using acro package
...
% Appendices
\appendicesSetup  % comment this if you do not have appendices
\begingroup
